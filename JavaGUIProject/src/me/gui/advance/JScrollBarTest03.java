...
public class JScrollBarTest03 extends JFrame implements ChangeListener{
	JScrollBar redScrollBar, greenScrollBar, blueScrollBar;
	JPanel centerPanel;
	public JScrollBarTest03() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setTitle("JScrollBarTest03 - ChangeListener");
		setSize(300, 400);
		...
		BoundedRangeModel redModel = redScrollBar.getModel();
		redModel.addChangeListener(this);
		...
		BoundedRangeModel greenModel = greenScrollBar.getModel();
		greenModel.addChangeListener(this);
		...
		BoundedRangeModel blueModel = blueScrollBar.getModel();
		blueModel.addChangeListener(this);
